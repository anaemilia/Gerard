...
*Conteúdo reconciliado em 2026-09-03 a partir de `.agents/skills/gerard-log-acao-instrumental/SKILL.md`
(mais recente). A versão anterior deste arquivo carecia da seção "Propriedade do registro" e de cinco
subseções de implementação datadas (P2.5A a P5.2, 2026-08-15 a 2026-08-25) descrevendo
`RegistroAcaoInstrumental`, `RegistroFactualAcaoInstrumental`, `RegistroAcaoClassificacaoCategoria`,
`TentativaClassificacaoCategoriaAditiva`, `RegistroAcaoRestauracaoModelagem`, `TentativaModelagemAditiva`
e `RegistroAcaoEscolhaSinalPapelQuantitativo` — todas as oito classes citadas foram confirmadas
presentes em `src/` antes desta substituição.*
