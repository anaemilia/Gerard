 ...
 * o proprietário semântico do papel quantitativo.
 *
 ...
 * só para o harness conferir se o julgamento local atual bate com o
 * julgamento humano original, e reportar divergências.
 *
 ...
 * sem nenhum caminho até o proprietário semântico, então não
 * há como reproduzir esse tipo de erro no nível de API sem
