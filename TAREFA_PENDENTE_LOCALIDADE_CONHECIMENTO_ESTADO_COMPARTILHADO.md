...
- **Fase B2, passo 2 (catalogar as 8 origens): autorizada a começar, só investigação — ver seção "Plano faseado", Fase B.** Nenhuma edição em `Main.java` até essa investigação ser apresentada e decidida item por item.
